...
#endif
static const char *ng0 = "C:/Users/17201/Desktop/CO/P4/module/ALU.v";
...
LAB70:    if (*((unsigned int *)t176) > 0)
        goto LAB71;

LAB72:    memcpy(t175, t213, 8);
...
LAB85:    if (*((unsigned int *)t239) > 0)
        goto LAB86;

LAB87:    if (*((unsigned int *)t214) > 0)
        goto LAB88;

LAB89:    memcpy(t213, t277, 8);

LAB90:    goto LAB68;

LAB69:    xsi_vlog_unsigned_bit_combine(t175, 32, t208, 32, t213, 32);
    goto LAB73;

LAB71:    memcpy(t175, t208, 8);
    goto LAB73;
...
LAB105:    if (*((unsigned int *)t304) > 0)
        goto LAB106;

LAB107:    if (*((unsigned int *)t278) > 0)
        goto LAB108;

LAB109:    memcpy(t277, t308, 8);

LAB110:    goto LAB85;

LAB86:    xsi_vlog_unsigned_bit_combine(t213, 32, t246, 32, t277, 32);
    goto LAB90;

LAB88:    memcpy(t213, t246, 8);
    goto LAB90;

LAB91:    t257 = *((unsigned int *)t246);
...
LAB104:    t308 = ((char*)((ng7)));
    goto LAB105;

LAB106:    xsi_vlog_unsigned_bit_combine(t277, 32, t309, 32, t308, 32);
    goto LAB110;

LAB108:    memcpy(t277, t309, 8);
    goto LAB110;
...
extern void work_m_00000000000646538033_0886308060_init()
{
	static char *pe[] = {(void *)Cont_28_0,(void *)Cont_33_1};
	xsi_register_didat("work_m_00000000000646538033_0886308060", "isim/mipstest_isim_beh.exe.sim/work/m_00000000000646538033_0886308060.didat");
